  ...
  var SubMap_CollectionView = Mn.CollectionView.extend(_.extend({
    ...
    showTiling: function (v_df) {
      ...
      if (!this.zoomed && this.overallMap != null) {
        ...
        console.log(t_nghList, t_distMat, t_codes)
        if (!this.zoomed) {
    ...
    aggregate: function () {
      class t_clsInfoObj {
        constructor (v_prevObj, v_treePath, v_isOut = false, v_nghPatterns, v_aggrDims) {
          ...
          this.dimensions = (v_aggrDims == null) ? (t_prevDims || t_aggrDims) : v_aggrDims
          this.patterns = (v_nghPatterns == null) ? (t_prevPatterns || t_nghPatterns) : v_nghPatterns
